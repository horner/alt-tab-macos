...
Take snapshots from Desktop labels, browse snapshot history from Project menus, and view Markdown summaries and window screenshots inside the app. Projects and archives live in editable folders under `~/.alt-tab-projects`.

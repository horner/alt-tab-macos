...
final class ProjectsSheet: SheetWindow {
    ...
    private static let spaceLabels = NSLocalizedString("Project labels", comment: "Project label controls")
    private static let showLabels = NSLocalizedString("Show Project Labels", comment: "Project label menu action")
    private static let closeLabels = NSLocalizedString("Close All Project Labels", comment: "Project label menu action")
    private static let raiseLabels = NSLocalizedString("Bring Project Labels to Front", comment: "Project label menu action")
    private static let minimizeLabels = NSLocalizedString("Minimize All Project Labels", comment: "Project label menu action")
    private static let revealLabels = NSLocalizedString("Show label after switching Spaces", comment: "Project label reveal duration setting")
    private static let revealHelp = NSLocalizedString("0 ms disables the automatic reveal. Closed or minimized labels stay hidden.", comment: "Project label reveal duration help")
